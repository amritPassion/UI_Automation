...
public class DemoPageMap extends CommonPageMap {
	...
	@FindBy(css = "#want-a-big-jump-in-revenues-sell-smarter-with-the-worlds-1-crm-platform-for-sales")
	public static WebElement salesCloudHomePage;
	
	// Sales Cloud Demo Registration link
	@FindBy(css = "div.leftnav-footer-non-affix > div.leftnav-btn > div > div > a")
	...
	@FindBy(css = "#form-container > ul > li:nth-child(7) > div > div.field > span[class='form-field-error show-form-field-error']")
	...
	@FindBy(css = "#form-container > div.submitButton.section > div > a > span")
